const dict = {
    ...
    ru: {
        ...
        rescue_external_swap: "Спасение внешнего свопа",
        refund_address_header:
        ...
        show_fiat_rate: "Показать курс USD",
        show_fiat_rate_tooltip: "Показать эквивалент суммы свопа в USD",
        fiat_rate_not_available: "Курс USD недоступен",
        ...
        claim: "Получить",
        claimed: "Своп успешно получен!",
        rescue: "Спасение",
        rescue_swap: "Спасение свопа",
        claim_swap: "Получить: {{ id }}",
        failed_get_swap: "Не удалось получить своп {{ id }}",
        failed_get_swap_subline:
        ...
        min_amount_destination:
            "Минимальная сумма для адреса назначения составляет {{ amount }} {{ denomination }}",
        max_amount_destination:
            "Максимальная сумма для адреса назначения составляет {{ amount }} {{ denomination }}",
        destination: "Назначение",
        destination_address: "{{ address }}",

        // Products page (not used)
        products: "Products",
        products_description:
            "A suite of products for seamless interoperability between Bitcoin layers",
        products_plugin_title: "Boltz BTCPay Plugin",
        ...
        claim_scan_required:
            "Чтобы получить этот своп, вернитесь назад и выполните сканирование, загрузив файл восстановления.",
        invalid_rescue_key_evm:
            "Этот ключ восстановления не связан с данным свопом. Пожалуйста, попробуйте еще раз, используя другой ключ восстановления.",
        error_occurred: "Произошла ошибка: {{ error }}",

        rsk_rescue_prompt:
            "Используйте функцию возврата средств, если вы отправляли RBTC, или функцию возобновления, если вы получали RBTC в рамках обмена, который недоступен в истории обменов этого браузера.",
        rsk_rescue_refund_title: "Вернуть своп",
        rsk_rescue_refund_explainer:
            "Подключите свой кошелек Rootstock, чтобы проверить наличие истекших свопов, по которым можно получить возврат средств.",

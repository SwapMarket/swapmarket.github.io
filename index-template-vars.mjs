...
const config = {
    regular: {
        boltzUrl: "https://swapmarket.github.io",
        boltzTitle: "SwapMarket",
        boltzDescription:
            "SwapMarket is a virtual broker for Non-Custodial Bitcoin Bridges. Swap between different Bitcoin layers while staying in full control. Fast and non-custodial Lightning / Bitcoin / Liquid / Rootstock swaps.",
